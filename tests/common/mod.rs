...
#[allow(dead_code)]
/// Test helper: send a PATCH request with JSON body and auth token.
...
#[allow(dead_code)]
/// Test helper: send a DELETE request with JSON body and auth token.
...
#[allow(dead_code)]
/// Test helper: send a PUT request with JSON body and auth token.
